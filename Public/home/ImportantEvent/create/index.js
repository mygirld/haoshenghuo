...
add.on("click",function () {
    add.i++;
    var str=' <div class="title"><span>记事'+add.i+'</span> <input type="text" class="input" placeholder="你的计划是什么" title="这是日记的标题"> <span>日期</span> <input type="text" class="datepicker"> </div>';
