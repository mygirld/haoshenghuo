        ...
        <div id="edit">
            <div class="nav">
                <ul>
                    ...
                    <li class="b"><span></span></li>
                    <li><a href="http://www.haoshenghuo.com/index.php/Home/Plan/create"  class="active" >计划</a></li>
                    <li class="b"><span></span></li>
                ...
                <div class="title">
                    <span>计划名</span>
                    <input type="text" class="input" id="title" placeholder="你的计划是什么" title="这是日记的标题">
                </div>
                <div class="title">
                    <span>第1步</span>
...
<script src="//apps.bdimg.com/libs/jqueryui/1.10.4/jquery-ui.min.js"></script>
    ...
    <script type="text/javascript" src="/Public/home/Plan/create/index.js"></script>
    <!--好友列表-->
